  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        sleep: "gradient-sleep text-primary-foreground shadow-lg glow-sleep hover:opacity-90 hover:-translate-y-0.5",
        mood: "gradient-mood text-primary-foreground shadow-lg glow-mood hover:opacity-90 hover:-translate-y-0.5",
        fitness: "gradient-fitness text-primary-foreground shadow-lg glow-fitness hover:opacity-90 hover:-translate-y-0.5",
        social: "gradient-social text-primary-foreground shadow-lg glow-social hover:opacity-90 hover:-translate-y-0.5",
